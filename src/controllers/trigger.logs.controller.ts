...
export const getTriggerLogs = async (req: Request, res: Response) => {
    try {
        const response = await TriggerLogService.getTriggerLogs(req.params.campaignId);
...
export const getUpcomingTriggers = async (req: Request, res: Response) => {
    try {
        const response = await TriggerLogService.getUpcomingTriggers(req.params.campaignId);
